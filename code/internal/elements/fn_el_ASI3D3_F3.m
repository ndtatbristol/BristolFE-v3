function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_ASI3D3_F3(nds, els, D, rho, varargin)
%SUMMARY
...
%	part of the filename, fn_el_ASI3D3_F3.
%INPUTS
...
%AUTHOR
%	Paul Wilcox (17-Apr-2026 01:05:01)
...
for g = 1:no_gauss_pts
	...
	%Define matrices that depend on Gauss point
		case 1
			...
			%Terms of G matrix
			G(1, 1, :) = (nds_1_2 - nds_2_2) .* (nds_1_3 - nds_3_3) - (nds_1_3 - nds_2_3) .* (nds_1_2 - nds_3_2);
			G(2, 1, :) = (nds_1_3 - nds_2_3) .* (nds_1_1 - nds_3_1) - (nds_1_1 - nds_2_1) .* (nds_1_3 - nds_3_3);
			G(3, 1, :) = (nds_1_1 - nds_2_1) .* (nds_1_2 - nds_3_2) - (nds_1_2 - nds_2_2) .* (nds_1_1 - nds_3_1);
