...
%AUTHOR
%	Paul Wilcox (07-Apr-2026 22:49:11)
...
for i = 1:no_gauss_pts
    ...
    switch i
        case 1
            ...
            B(1, 2, :) = -(nds_2_1 - nds_3_1) ./ detJ;
            B(1, 3, :) = (nds_2_1 - nds_3_1) ./ detJ - (nds_2_2 - nds_3_2) ./ detJ;
            B(2, 1, :) = -(nds_1_2 - nds_3_2) ./ detJ;
            B(2, 2, :) = (nds_1_1 - nds_3_1) ./ detJ;
            B(2, 3, :) = (nds_1_2 - nds_3_2) ./ detJ - (nds_1_1 - nds_3_1) ./ detJ;
