function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_AC2D3_f1(nds, els, D, rho, varargin)
%SUMMARY
...
%	part of the filename, fn_el_AC2D3_f1.
%INPUTS
...
%AUTHOR
%	Paul Wilcox (12-Apr-2026 09:06:40)
...
for g = 1:no_gauss_pts
	...
	switch g
		case 1
			...
			%Terms of K matrix
			K(1, 1, :) = (D .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :)) .* (J(1, 1, :) .^ 2 + J(1, 2, :) .^ 2 + J(2, 1, :) .^ 2 + J(2, 2, :) .^ 2 - 2 .* J(1, 1, :) .* J(2, 1, :) - 2 .* J(1, 2, :) .* J(2, 2, :))) ./ detJ .^ 2;
			K(1, 2, :) = -(D .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :)) .* (J(2, 1, :) .^ 2 + J(2, 2, :) .^ 2 - J(1, 1, :) .* J(2, 1, :) - J(1, 2, :) .* J(2, 2, :))) ./ detJ .^ 2;
			K(1, 3, :) = -(D .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :)) .* (J(1, 1, :) .^ 2 + J(1, 2, :) .^ 2 - J(1, 1, :) .* J(2, 1, :) - J(1, 2, :) .* J(2, 2, :))) ./ detJ .^ 2;
			K(2, 1, :) = K(1, 2, :);
			K(2, 2, :) = (D .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :)) .* (J(2, 1, :) .^ 2 + J(2, 2, :) .^ 2)) ./ detJ .^ 2;
			K(2, 3, :) = -(D .* (J(1, 1, :) .* J(2, 1, :) + J(1, 2, :) .* J(2, 2, :)) .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :))) ./ detJ .^ 2;
			K(3, 1, :) = K(1, 3, :);
			K(3, 2, :) = K(2, 3, :);
			K(3, 3, :) = (D .* (J(1, 1, :) .* J(2, 2, :) - J(1, 2, :) .* J(2, 1, :)) .* (J(1, 1, :) .^ 2 + J(1, 2, :) .^ 2)) ./ detJ .^ 2;
