...
no_nds = 4; %number of nodes of element
...
tmp_q2 = [-1, 1];
tmp = [
    1, tmp_q1(1), tmp_q2(1), tmp_q1(1) * tmp_q2(1)
    1, tmp_q1(2), tmp_q2(1), tmp_q1(2) * tmp_q2(1)
    1, tmp_q1(2), tmp_q2(2), tmp_q1(2) * tmp_q2(2)
    1, tmp_q1(1), tmp_q2(2), tmp_q1(1) * tmp_q2(2)
    ];
itmp = inv(tmp);
for i = 1:4
    n(i) = itmp(i, 1) + itmp(i, 2) * q(1) + itmp(i, 3) * q(2) + itmp(i, 4) * q(1) * q(2);
end
