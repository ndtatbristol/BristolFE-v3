function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_AC2D3_test(nds, els, D, rho, varargin)
%SUMMARY
...
%	part of the filename, fn_el_AC2D3_test.
%INPUTS
...
%AUTHOR
%	Paul Wilcox (25-Mar-2026 15:56:10)
...
el_K(:, 1, 1) = -(nds_2_1 .^ 2 - 2 .* nds_2_2 .* nds_3_2 - 2 .* nds_2_1 .* nds_3_1 + nds_2_2 .^ 2 + nds_3_1 .^ 2 + nds_3_2 .^ 2) ./ (2 .* detJ(:, 1, 1) .* rho);
el_K(:, 1, 2) = (nds_1_1 .* nds_2_1 + nds_1_2 .* nds_2_2 - nds_1_1 .* nds_3_1 - nds_1_2 .* nds_3_2 - nds_2_1 .* nds_3_1 - nds_2_2 .* nds_3_2 + nds_3_1 .^ 2 + nds_3_2 .^ 2) ./ (2 .* detJ(:, 1, 1) .* rho);
el_K(:, 1, 3) = -(nds_1_1 .* nds_2_1 + nds_1_2 .* nds_2_2 - nds_1_1 .* nds_3_1 - nds_1_2 .* nds_3_2 + nds_2_1 .* nds_3_1 + nds_2_2 .* nds_3_2 - nds_2_1 .^ 2 - nds_2_2 .^ 2) ./ (2 .* detJ(:, 1, 1) .* rho);
el_K(:, 2, 1) = el_K(:, 1, 2);
el_K(:, 2, 2) = -(detJ(:, 1, 1) .* ((D .* (nds_1_1 - nds_3_1) .^ 2) ./ detJ(:, 1, 1) .^ 2 + (D .* (nds_1_2 - nds_3_2) .^ 2) ./ detJ(:, 1, 1) .^ 2)) ./ (2 .* D .* rho);
el_K(:, 2, 3) = (detJ(:, 1, 1) .* ((D .* (nds_1_1 - nds_2_1) .* (nds_1_1 - nds_3_1)) ./ detJ(:, 1, 1) .^ 2 + (D .* (nds_1_2 - nds_2_2) .* (nds_1_2 - nds_3_2)) ./ detJ(:, 1, 1) .^ 2)) ./ (2 .* D .* rho);
el_K(:, 3, 1) = el_K(:, 1, 3);
el_K(:, 3, 2) = el_K(:, 2, 3);
el_K(:, 3, 3) = -(detJ(:, 1, 1) .* ((D .* (nds_1_1 - nds_2_1) .^ 2) ./ detJ(:, 1, 1) .^ 2 + (D .* (nds_1_2 - nds_2_2) .^ 2) ./ detJ(:, 1, 1) .^ 2)) ./ (2 .* D .* rho);
...
el_M(:, 1, 1) = -detJ(:, 1, 1) ./ (6 .* D);
el_M(:, 2, 2) = -detJ(:, 1, 1) ./ (6 .* D);
el_M(:, 3, 3) = -detJ(:, 1, 1) ./ (6 .* D);
