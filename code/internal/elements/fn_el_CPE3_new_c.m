function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_CPE3_new_c(nds, els, D, rho, varargin)
%SUMMARY
...
%	part of the filename, fn_el_CPE3_new_c.
%INPUTS
...
%AUTHOR
%	Paul Wilcox (30-Mar-2026 13:45:41)
...
for i = 1:no_gauss_pts
    ...
    switch i
        case 1
            detJ = nds_1_2 .* nds_2_1 - nds_1_1 .* nds_2_2 + nds_1_1 .* nds_3_2 - nds_1_2 .* nds_3_1 - nds_2_1 .* nds_3_2 + nds_2_2 .* nds_3_1;
