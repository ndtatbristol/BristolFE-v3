function [el_K, el_C, el_M, loc_nd, loc_df] = fn_el_ASI2D2_F1(nds, els, D, rho, varargin)
%SUMMARY
...
%	part of the filename, fn_el_ASI2D2_F1.
%INPUTS
...
for g = 1:no_gauss_pts
	...
	%Define matrices that depend on Gauss point
		case 1
			...
			C_up(1, 1, :) = nds_1_2 ./ 4 - nds_2_2 ./ 4;
			C_up(1, 2, :) = nds_1_2 ./ 4 - nds_2_2 ./ 4;
			C_up(2, 1, :) = nds_2_1 ./ 4 - nds_1_1 ./ 4;
			C_up(2, 2, :) = nds_2_1 ./ 4 - nds_1_1 ./ 4;
			C_up(4, 1, :) = nds_1_2 ./ 4 - nds_2_2 ./ 4;
			C_up(4, 2, :) = nds_1_2 ./ 4 - nds_2_2 ./ 4;
			C_up(5, 1, :) = nds_2_1 ./ 4 - nds_1_1 ./ 4;
			C_up(5, 2, :) = nds_2_1 ./ 4 - nds_1_1 ./ 4;
