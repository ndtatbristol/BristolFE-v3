function matl = fn_matl_fluid_defined_by_bulk_modulus(name, bulk_modulus, density, varargin)
%USAGE
...
%   bulk_modulus, density - as per variable names
...
default_options.min_colour = hsv2rgb([0.6,0.5,0.8]);
default_options.max_colour = hsv2rgb([0.6,0.5,0.2]);
default_options.zmin = 1e6;
default_options.zmax = 100e6;
