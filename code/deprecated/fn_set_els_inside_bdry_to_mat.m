...
warning(['fn_set_els_inside_bdry_to_mat is deprecated function: ' ...
    'use in = fn_2d_find_elements_in_region instead and then set mod.el_mat_i(in) to mat_i'])
%SUMMARY
...
in = fn_2d_find_elements_in_region(mod, bdry_pts);
